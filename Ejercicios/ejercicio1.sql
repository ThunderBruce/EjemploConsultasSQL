...
CONSTRAINT UQ_COMPRADORES_NOMBRE_SOCIAL UNIQUE(Telefono));
...
CONSTRAINT PK_FACTURAS AUTO_INCREMENT PRIMARY KEY (Factura_no)):
...
ALTER TABLE FACTURAS
ADD CONSTRAINT FK_FACTURA_COMPRADORES FOREIGN KEY (CIF_cliente) REFERENCES COMPRADORES(CIF_comprador);
